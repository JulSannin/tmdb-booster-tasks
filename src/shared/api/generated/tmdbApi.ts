...
const injectedRtkApi = api.injectEndpoints({
    endpoints: (build) => ({
        ...
        get3TvChanges: build.query<
            Get3TvChangesApiResponse,
            Get3TvChangesApiArg
        >({
            query: (queryArg) => ({
                url: `/3/tv/changes`,
        ...
        >({
            query: (queryArg) => ({
                url: `/3/company/${queryArg.companyId}/images`,
            }),
        }),
            ...
            query: (queryArg) => ({
                ...
                params: {
                    ...
                    with_watch_monetization_types:
                        queryArg.withWatchMonetizationTypes,
            ...
            query: (queryArg) => ({
                ...
                params: {
                    ...
                    include_null_first_air_dates:
                        queryArg.includeNullFirstAirDates,
                    language: queryArg.language,
                    page: queryArg.page,
        ...
        >({
            query: (queryArg) => ({
                url: `/3/movie/${queryArg.movieId}/keywords`,
            }),
        }),
        ...
        >({
            query: (queryArg) => ({
                url: `/3/network/${queryArg.networkId}/images`,
            }),
        }),
        ...
        >({
            query: (queryArg) => ({
                url: `/3/person/${queryArg.personId}/images`,
            }),
        }),
        ...
        get3TvPopular: build.query<
            Get3TvPopularApiResponse,
            Get3TvPopularApiArg
        >({
            query: (queryArg) => ({
                url: `/3/tv/popular`,
        ...
        >({
            query: (queryArg) => ({
                url: `/3/tv/${queryArg.seriesId}/external_ids`,
            }),
        }),
        ...
        >({
            query: (queryArg) => ({
                url: `/3/tv/${queryArg.seriesId}/keywords`,
            }),
        }),
        ...
        >({
            query: (queryArg) => ({
                url: `/3/tv/${queryArg.seriesId}/translations`,
            }),
        }),
